...
[![npm version](https://badge.fury.io/js/@hapic%2Fvictorialogs.svg)](https://badge.fury.io/js/@hapic%2Fvictorialogs)
...
This client provides a convenient way to interact with various endpoints of victorialogs.
...
```bash
npm install @hapic/victorialogs --save
```
